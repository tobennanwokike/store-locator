...
describe('Routes status codes', () => {
    describe('Main route', () => {
        it('Status code testing', (done) => {
            request(`http://localhost:${appConfig.port}/`, (err, resp, body) => {
    ...
    describe('Closest routes testing', () => {
        it('zipcode testing', (done) => {
            request(`http://localhost:${appConfig.port}/closest`, (err, resp, body) => {
    ...
    describe('Closest route zip code testing', () => {
        it('zipcode route: status code', (done) => {
            request(`http://localhost:${appConfig.port}/closest?zip=01752`, (err, resp, body) => {
                expect(resp.statusCode).to.equal(200);
                done();
            });
        });
        ...
        it('zipcode route: invalid zip code test with decimals', (done) => {
            request(`http://localhost:${appConfig.port}/closest?zip=111.90`, (err, resp, body) => {
                expect(resp.statusCode).to.equal(400);
                done();
            });
        });
        it('zipcode route: invalid but complete zip code test', (done) => {
            request(`http://localhost:${appConfig.port}/closest?zip=00000`, (err, resp, body) => {
                expect(resp.statusCode).to.equal(400);
                done();
            });
        });
        it('zipcode route: empty zip code test', (done) => {
            request(`http://localhost:${appConfig.port}/closest?zip=`, (err, resp, body) => {
                expect(resp.statusCode).to.equal(404);
                done();
            });
        });
        it('zipcode route: empty zip code test with units', (done) => {
            request(`http://localhost:${appConfig.port}/closest?zip=01752&units=km`, (err, resp, body) => {
                expect(resp.statusCode).to.equal(200);
                done();
            });
        });
        it('zipcode route: empty zip code test empty units', (done) => {
            request(`http://localhost:${appConfig.port}/closest?zip=01752&units=`, (err, resp, body) => {
                expect(resp.statusCode).to.equal(200);
                done();
            });
        });
